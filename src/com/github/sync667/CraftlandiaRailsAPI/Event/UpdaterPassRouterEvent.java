...
/**
 * Event triggered when an updater pass a router of the same level. A region updater will trigger this event on BC8010
 * sign. A backbone updater will trigger this event on BC8020 sign. A local updater will never trigger this event
 */
