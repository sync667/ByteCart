...
public abstract class BCRoutableSignEvent extends BCEvent{
     ...
     * <p>
     * Possible values are: - LOCAL for all BC9XXX signs - REGION for a BC8010 router - BACKBONE for a BC8020 router
     *
    ...
    /**
     * Get the string on the 3rd line of the sign. This is where users can put a name.
     *
    ...
    /**
     * Get the string on the 2nd line of the sign without the brackets
     *
