...
/**
 * Event triggered when a vehicle is entering a router, before the collision avoidance layer operations.
 * <p>
...
public final class SignPreRouteEvent extends SignPostRouteEvent{
    ...
    /**
     * Modify the destination ring on the fly to override the routing layer. This will modify internal state of the
     * router before actual operations. This will not change the destination address recorded in the vehicle.
     * <p>
