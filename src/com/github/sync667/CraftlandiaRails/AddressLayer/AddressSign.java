...
import com.github.sync667.CraftlandiaRails.IO.AbstractComponent;
...
/*
			if(CraftlandiaRails.debug)
				CraftlandiaRails.log.info("CraftlandiaRails: creating AddressSign line #" + ligne + " at " + block.getLocation().toString());
	*/
    }
