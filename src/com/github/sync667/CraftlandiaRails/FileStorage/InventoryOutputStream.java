    ...
    public void flush() throws IOException {
        ...
        if (count > this.inventory.getSize()) {
            if (CraftlandiaRails.debug) {
                CraftlandiaRails.log.info(count + " books are needed, maximum is " + this.inventory.getSize());
            }
        ...
        if (CraftlandiaRails.debug) {
            CraftlandiaRails.log.info("CraftlandiaRails : Flushing " + len + " bytes of data to books");
        }
    }
}
