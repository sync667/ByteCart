...
public final class BookProperties implements Closeable, Flushable{
     ...
     */
    public enum Conf{
        NETWORK("Network"), BILLING("Billing"), ACCESS("Access"), PROTECTION("Protection"), HISTORY("History");
    ...
    public void setProperty(String key, String value) throws IOException {
        if (CraftlandiaRails.debug) {
            CraftlandiaRails.log.info("CraftlandiaRails: BookProperties : setting key " + key + " to " + value);
        }
    ...
    public void clearProperty(String key) throws IOException {
        if (CraftlandiaRails.debug) {
            CraftlandiaRails.log.info("CraftlandiaRails: BookProperties : clearing key " + key);
        }
    ...
    public int getInt(String key, int defaultvalue) {
        if (CraftlandiaRails.debug) {
            CraftlandiaRails.log
                    .info("CraftlandiaRails: property string : " + Properties.getProperty(key, "" + defaultvalue));
        }
